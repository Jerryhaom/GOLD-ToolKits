...
vignette: >
  %\VignetteIndexEntry{GOLDToolkits Tutorial}
...
## Introduction
The GOLDToolkits package provides comprehensive methods for estimating biological age and assessing mortality risk using various statistical approaches. Biological age represents the functional state of an individual relative to their chronological age, which can be estimated from biomarkers and clinical data. This vignette demonstrates three main methods: GOLD, GOLD-R, GOLD-RL.
...
## GOLD Biological Age Estimation
```{r, echo=T}
#GOLD Method
...
## Survival Analysis
Kaplan-Meier Curves by Biological Age Quartiles
```{r, echo=T}
...
## Comparison Across GOLD Methods
Compare survival differences using residuals from different GOLD methods:
